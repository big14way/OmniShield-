...
contract HederaBridge is Ownable, ReentrancyGuard {
    ...
    event BridgeCompleted(uint256 indexed requestId, bytes32 indexed hederaTxHash);
    ...
    function completeBridge(uint256 requestId, bytes32 hederaTxHash) external onlyOwner {
